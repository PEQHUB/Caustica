...
int main() {
    ...
    static_assert(static_cast<uint32_t>(sl::DLSSDPreset::eDefault) == 0);
    static_assert(static_cast<uint32_t>(sl::DLSSDPreset::ePresetD) == 4);
    static_assert(static_cast<uint32_t>(sl::DLSSDPreset::ePresetE) == 5);
    static_assert(sizeof(sl::float4x4) == 64);
    static_assert(sizeof(slbridge_resource_desc) == 80);
    static_assert(offsetof(slbridge_resource_desc, extent_width) == 68);
    static_assert(offsetof(slbridge_resource_desc, extent_height) == 72);
    ...
    static_assert(sl::kBufferTypeParticleHint == SLBRIDGE_BUFFER_PARTICLE_HINT);
