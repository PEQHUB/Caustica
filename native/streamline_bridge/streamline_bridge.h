...
enum slbridge_buffer_type {
    ...
    SLBRIDGE_BUFFER_DISOCCLUSION_MASK = 11,
    SLBRIDGE_BUFFER_NORMAL_ROUGHNESS = 14,
    SLBRIDGE_BUFFER_UI_COLOR_AND_ALPHA = 23,
    SLBRIDGE_BUFFER_PARTICLE_HINT = 26,
    SLBRIDGE_BUFFER_BIAS_CURRENT_COLOR_HINT = 29,
    SLBRIDGE_BUFFER_COLOR_BEFORE_TRANSPARENCY = 40,
    SLBRIDGE_BUFFER_DIFFUSE_RAY_DIRECTION_HIT_DISTANCE = 46,
    SLBRIDGE_BUFFER_TRANSPARENCY_LAYER = 51,
    SLBRIDGE_BUFFER_TRANSPARENCY_LAYER_OPACITY = 52,
