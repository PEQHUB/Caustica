...
final class RtDlssFgFixedMultiplierTest {
    ...
    @Test
    void passesDisplayedTargetToReflexWithoutApplyingMultiplierTwice() {
        assertEquals(4_444, RtDlssFg.reflexLimitForDisplayedTarget(225));
        assertEquals(8_333, RtDlssFg.reflexLimitForDisplayedTarget(120));
    }
