 ...
 *
 * <p>PsychoV24 is the SDR and HDR default; ACES 2.0 remains mode 0 for the
 * reference LUT path. Unknown config values fall back to the appropriate output's safe default. The
