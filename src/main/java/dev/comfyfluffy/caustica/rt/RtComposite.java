...
public final class RtComposite {
    ...
    private static final int BASE_GUIDE_COUNT = 20;
    private static final int NRD_GUIDE_COUNT = 20;
    ...
    private RtImage gTransparencyLayerOpacity;
    ...
    private void bindGuideImages() {
        if (gNormal != null) {
            for (RtPipeline pipeline : onlinePipelines()) if (pipeline != null) {
                ...
                pipeline.setExtraStorageImage(19, gTransparencyLayerOpacity.view);
            }
    ...
    private void destroyGuideImages() {
        ...
        if (gTransparencyLayerOpacity != null) {
            gTransparencyLayerOpacity.destroy();
            gTransparencyLayerOpacity = null;
        }
    ...
    private void ensureOutput(RtContext ctx, int width, int height) {
        ...
        gTransparencyLayerOpacity = ctx.createStorageImage(dlssGuideW, dlssGuideH,
                VK10.VK_FORMAT_R16G16B16A16_SFLOAT, "DLSSD portal transparency opacity");
        if (dlssOperational) {
                ...
                try (RtDebugLabels.Scope ignored = RtDebugLabels.scope(ctx, cmd, reconstructionLabel);
                    ...
                    if (RtReconstruction.usesDlss()) {
                        rrDone = RtDlssRr.INSTANCE.evaluate(cmd.address(), output, gDepth, gMotion, gAlbedo,
                                ...
                                gTransparencyLayer, gTransparencyLayerOpacity, dlssdOutput,
