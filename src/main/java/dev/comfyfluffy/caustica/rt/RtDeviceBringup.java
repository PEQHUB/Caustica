...
public final class RtDeviceBringup {
    ...
    private record FeatureSupport(List<String> missingRequired, SerBackend serBackend,
                                  ...
                                  boolean sharcInt64Atomics, boolean sharcFloat16,
                                  boolean sharcStorageBuffer16) {
        boolean supportsRt() {
    ...
    private static FeatureSupport queryFeatureSupport(VulkanPhysicalDevice physicalDevice) {
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            if (querySharc) {
                ...
                SHARC_SHADER_FLOAT16_FEATURE.struct().findOrCreateStructInPNextChain(available, stack);
            ...
            return new FeatureSupport(missing, supportedSer,
                    ...
                    querySharc && SHARC_SHADER_FLOAT16_FEATURE.get(available),
    ...
    public static void addFeatures(Args args, VulkanPhysicalDevice physicalDevice) {
        ...
        boolean sharcFeatures = sharcPackaged && support.sharcInt64Atomics
                && support.sharcFloat16 && support.sharcStorageBuffer16;
